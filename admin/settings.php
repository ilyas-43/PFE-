...
<body class="bg-light">
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <div class="mb-3">
                                ...
                                <input type="text" name="address" id="address_inp" class="form-control shadow-none" rows="6" required></input>
                              </div>
                              <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="iframe" id="iframe_inp" class="form-control shadow-none" rows="6" required></input>
                              </div>
    ...
    <script>
      ...
      function upd_general(site_about_val)
      {
        ...
        xhr.send('site_about='+site_about_val+'&upd_general');
      ...
      function contacts_inp(data)
       {
        ...
        for(i=0;i<contacts_inp_id.length;i++){
          document.getElemntById(contacts_inp_id[i]).value = data[i+1]
        }
      }
      ...
      function upd_contacts() 
      {
        ...
        for(i=0;i<index.length;i++){
          data_str += index[1] +"=" + document.getElementById(contacts_inp_id[i]).value + '&';
        }
