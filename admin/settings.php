                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <div class="mb-3">
                                ...
                                <input type="text" name="address" id="address_inp" class="form-control shadow-none" rows="6" required>
                              </div>
                              <div class="mb-3">
                            ...
                            <div class="col-md-6">
                              ...
                              <div class="mb-3">
                                ...
                                <input type="text" name="iframe" id="iframe_inp" class="form-control shadow-none" rows="6" required>
                              </div>
                            </div>
                          </div>
                        </div>
